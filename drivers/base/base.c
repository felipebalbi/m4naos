...
static DECLARE_DEVICE(APB1_USART2, usart2, &uart2_reset, &uart2_clk, false);
static DECLARE_DEVICE(APB1_USART3, usart3, &uart3_reset, &uart3_clk, false);
static DECLARE_DEVICE(APB1_UART4, uart4, &uart4_reset, &uart4_clk, false);
static DECLARE_DEVICE(APB1_UART5, uart5, &uart5_reset, &uart5_clk, false);
...
static DECLARE_DEVICE(APB1_UART7, uart7, &uart7_reset, &uart7_clk, false);
static DECLARE_DEVICE(APB1_UART8, uart8, &uart8_reset, &uart8_clk, false);
...
static DECLARE_DEVICE(APB2_USART6, usart6, &usart6_reset, &usart6_clk, false);
